...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/slm-logo-800x800.png" },
      { property: "og:image:width", content: "800" },
      { property: "og:image:height", content: "800" },
      { property: "og:image:type", content: "image/png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SLM - Simple Logo Maker" },
      {
        name: "twitter:description",
        content: "Make a clean text logo with gradients and any Google Font. Export SVG or PNG.",
      },
      { name: "twitter:image", content: "/slm-logo-800x800.png" },
    ],
    links: [
      {
        rel: "stylesheet",
